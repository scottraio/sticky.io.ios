...
- (void)useBlueStyle
{
    ...
    UIColor *topBlue = UIColorFromRGB(0x0086cc);
    UIColor *bottomBlue = UIColorFromRGB(0x00589a);
    UIColor *borderBlue = UIColorFromRGB(0x003580);
    
    self.cornerRadius = 6.0f;
    
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:2];
	[colors addObject:(id)[bottomBlue CGColor]];
	[colors addObject:(id)[topBlue CGColor]];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSMutableArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
                                    [NSNumber numberWithFloat:1.0f],
	...
	[colors2 addObject:(id)[topBlue CGColor]];
	[colors2 addObject:(id)[bottomBlue CGColor]];
